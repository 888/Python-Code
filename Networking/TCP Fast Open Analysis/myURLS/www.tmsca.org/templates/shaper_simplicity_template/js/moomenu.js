if (typeof(MooTools) != 'undefined'){
		...
		Element.extend(
		{
			...
			init: function() {
				...
				if (this.parent._id)
            {
               this.myFx2 = new Fx.Style(this, 'width', {transition: Fx.Transitions.Sine.easeOut}, {duration: 500});
               this.myFx2.set(0);
            }else{
               this.myFx2 = new Fx.Style(this, 'height', {transition: Fx.Transitions.Sine.easeOut}, {duration: 500});
               this.myFx2.set(0);
            }
		...
		sfHover = function() {
		var sfEls = document.getElementById("hornav").getElementsByTagName("li");
