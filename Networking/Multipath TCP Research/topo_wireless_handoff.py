...
class Topo1(Topo):
    ...
    def __init__(self, n=1, cpu=.1, bw=100, delay=None,
        ...
        # TODO
        ethernetConfig = {'bw': 10, 'delay': 1, 'loss': 0, 'max_queue_size':max_queue_size}
	wifiConfig = {'bw': 2, 'delay': 5, 'loss': 3, 'max_queue_size':max_queue_size}
	threegConfig = {'bw': 2, 'delay': 75, 'loss': 2, 'max_queue_size': max_queue_size}
	hostConfig = {'cpu': cpu}
	...
	s3 = self.addSwitch('s3')
	    ...
	    # Wire receiver
        # TODO
	self.addLink(receiver, s1, **ethernetConfig)
	self.addLink(receiver, s2, **wifiConfig)
	self.addLink(receiver, s3, **threegConfig)
	

        # Wire sender
        # TODO
	self.addLink(sender, s1, **ethernetConfig)
	self.addLink(sender, s2, **ethernetConfig)
	self.addLink(sender, s3, **ethernetConfig)
