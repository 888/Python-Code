...
ATTACKBODY_PATH = "tpotter8.pcap" # replace the file name by the one you downloaded
...
if __name__ == '__main__':
	...
	while len(xor_table) < 124:  # CHECK: 124 can be some other number (multiple of 4) per your attack trace length
